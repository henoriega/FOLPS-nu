...
#################  FLOPSnu  ########################
# This code computes the redshift space power spectrum multipoles in a fraction of second.
# Requirement: update your numpy to versions 1.20.0 or higher. Otherwise rescale c_m by a factor 1/N.
...
def Matrices(FFTLogParams):
    ...
    #print('Computation time for all matrices/vectors (N='+str(N)+') =',time_M, 's')
...
def LoopCorr(inputpkT, CosmoParams, FFTLogParams, NeuEffect):
    ...
    #Returns $f(k)/f_0$ & f0 following H&E (1998)
